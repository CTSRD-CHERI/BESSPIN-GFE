...
module mkGpio(CLK,
  ...
  assign slave_xactor_f_rd_data$D_IN =
	     { slave_xactor_f_rd_addr$D_OUT[99:93], 67'd5 } ;
  ...
  assign slave_xactor_f_wr_resp$D_IN =
	     { slave_xactor_f_wr_addr$D_OUT[99:93], v__h1004 } ;
  ...
  begin
    ...
    v__h1296 = v__h1302 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req)
	$display("%0d: GPIO.rl_process_wr_req:", v__h1296);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req) $write("'h%h", v__h1004);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1565 = v__h1571 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  slave_xactor_f_wr_addr_first__7_BITS_31_TO_29__ETC___d53 &&
	  slave_xactor_f_wr_data$D_OUT[72:9] == 64'd1)
	$display("%0d: ASSERTING SOFT RESET!", v__h1565);
    if (RST_N != `BSV_RESET_VALUE)
