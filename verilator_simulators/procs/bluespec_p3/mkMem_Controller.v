...
module mkMem_Controller(CLK,
  ...
  wire [73 : 0] MUX_slave_xactor_f_rd_data$enq_1__VAL_1,
		MUX_slave_xactor_f_rd_data$enq_1__VAL_2;
  wire [8 : 0] MUX_slave_xactor_f_wr_resp$enq_1__VAL_1,
  ...
  reg [63 : 0] rdata__h4901, word64_old__h5701;
  wire [63 : 0] exit_value__h7720,
		f_reqs_rv_BITS_164_TO_101_MINUS_rg_addr_base__q1,
		mask__h5705,
		req_raw_mem_addr__h3089,
		updated_word64__h5707,
		word64_new__h5706,
		x__h6089,
		y__h6090;
  ...
  assign WILL_FIRE_RL_rl_process_rd_req =
	     f_reqs_rv[173] && slave_xactor_f_rd_data$FULL_N &&
	     rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d130 &&
	     rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 &&
	     !f_reqs_rv[172] ;
  ...
  assign WILL_FIRE_RL_rl_process_wr_req =
	     f_reqs_rv[173] && slave_xactor_f_wr_resp$FULL_N &&
	     rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d130 &&
	     rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 &&
	     f_reqs_rv[172] ;
  ...
  assign WILL_FIRE_RL_rl_merge_rd_req =
	     slave_xactor_f_rd_addr$EMPTY_N && !f_reqs_rv$port1__read[173] ;

  // rule RL_rl_merge_wr_req
  assign WILL_FIRE_RL_rl_merge_wr_req =
	     !f_reqs_rv$port1__read[173] && slave_xactor_f_wr_addr$EMPTY_N &&
	     slave_xactor_f_wr_data$EMPTY_N &&
	     !WILL_FIRE_RL_rl_merge_rd_req ;
  ...
  assign MUX_slave_xactor_f_rd_data$enq_1__VAL_1 =
	     { f_reqs_rv[171:165], rdata__h4901, 3'd1 } ;
  ...
  assign exit_value__h7720 = { 1'd0, word64_new__h5706[63:1] } ;
  ...
  assign n__h4900 = { 3'd0, f_reqs_rv[105:104] } ;
  assign req_raw_mem_addr__h3089 =
	     { 5'd0,
  ...
  assign rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 =
	     rg_cached_raw_mem_addr == req_raw_mem_addr__h3089 ;
  ...
  assign rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 =
	     ...
	     word64_new__h5706 != 64'd0 ;
  assign updated_word64__h5707 = x__h6089 | word64_new__h5706 ;
  assign word64_new__h5706 = f_reqs_rv[63:0] & mask__h5705 ;
  assign x__h6089 = word64_old__h5701 & y__h6090 ;
  assign y__h6090 =
	     { ~SEXT_f_reqs_rv_port0__read__2_BIT_71_89___d190,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_70_92___d193,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_69_96___d197,
  ...
  begin
    case (f_reqs_rv[105:104])
      2'd0: word64_old__h5701 = rg_cached_raw_mem_word[63:0];
      2'd1: word64_old__h5701 = rg_cached_raw_mem_word[127:64];
      2'd2: word64_old__h5701 = rg_cached_raw_mem_word[191:128];
      2'd3: word64_old__h5701 = rg_cached_raw_mem_word[255:192];
    endcase
  end
  always@(n__h4900 or rg_cached_raw_mem_word)
  begin
    case (n__h4900)
      5'd0: rdata__h4901 = rg_cached_raw_mem_word[63:0];
      5'd1: rdata__h4901 = rg_cached_raw_mem_word[127:64];
      5'd2: rdata__h4901 = rg_cached_raw_mem_word[191:128];
      5'd3: rdata__h4901 = rg_cached_raw_mem_word[255:192];
      default: rdata__h4901 = 64'hAAAAAAAAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    v__h5240 = v__h5246 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_rd_req: ", v__h5240);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_wr_req: ", v__h7460);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 &&
	  word64_new__h5706[63:1] == 63'd0)
	$display("PASS");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 &&
	  word64_new__h5706[63:1] != 63'd0)
	$display("FAIL %0d", exit_value__h7720);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242)
	$finish({ 30'd0, word64_new__h5706[2:1] });
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8186 = v__h8192 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address)
	$write("%0d: ERROR: Mem_Controller:", v__h8186);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address &&
	  NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d280)
    ...
    v__h8989 = v__h8995 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address)
	$write("%0d: ERROR: Mem_Controller:", v__h8989);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address &&
	  NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d280)
    ...
    v__h2628 = v__h2634 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_rd_req", v__h2628);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
    ...
    v__h2953 = v__h2959 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_wr_req", v__h2953);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_state == 2'd0 && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_power_on_reset", v__h1637);
    if (RST_N != `BSV_RESET_VALUE)
