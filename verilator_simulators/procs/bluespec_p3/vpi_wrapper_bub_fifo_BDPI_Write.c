 ...
 *     #include "vpi_wrapper_bub_fifo_BDPI_Write.h"
 *     void (*vlog_startup_routines[])() = { bub_fifo_BDPI_Write_vpi_register, 0u };
 * 
 * For a Verilog simulator which requires a .tab file, use the following entry:
 * $imported_bub_fifo_BDPI_Write call=bub_fifo_BDPI_Write_calltf size=1 acc=rw:%TASK
 * 
 * For a Verilog simulator which requires a .sft file, use the following entry:
 * $imported_bub_fifo_BDPI_Write vpiSysFuncSized 1 unsigned
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
char bub_fifo_BDPI_Write(unsigned long long , unsigned int *);

/* VPI wrapper function */
PLI_INT32 bub_fifo_BDPI_Write_calltf(PLI_BYTE8 *user_data)
{
  vpiHandle hCall;
  ...
  vpi_result = bub_fifo_BDPI_Write(arg_1, arg_2);
...
/* sft: $imported_bub_fifo_BDPI_Write vpiSysFuncSized 1 unsigned */

/* tab: $imported_bub_fifo_BDPI_Write call=bub_fifo_BDPI_Write_calltf size=1 acc=rw:%TASK */

PLI_INT32 bub_fifo_BDPI_Write_sizetf(PLI_BYTE8 *user_data)
{
  return 1u;
}

/* VPI wrapper registration function */
void bub_fifo_BDPI_Write_vpi_register()
{
  ...
  tf_data.tfname = "$imported_bub_fifo_BDPI_Write";
  tf_data.calltf = bub_fifo_BDPI_Write_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = bub_fifo_BDPI_Write_sizetf;
  tf_data.user_data = "$imported_bub_fifo_BDPI_Write";
